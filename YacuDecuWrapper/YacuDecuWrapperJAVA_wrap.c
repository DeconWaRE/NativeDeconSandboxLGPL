...
SWIGEXPORT jint JNICALL Java_com_deconware_wrappers_YacuDecu_1swigJNI_deconv_1device(JNIEnv *jenv, jclass jcls, jlong jarg1, jlong jarg2, jlong jarg3, jlong jarg4, jfloatArray jarg5, jfloatArray jarg6, jfloatArray jarg7) {
  jint jresult = 0 ;
  unsigned int arg1 ;
  size_t arg2 ;
  size_t arg3 ;
  ...
  if (!SWIG_JavaArrayInFloat(jenv, &jarr7, (float **)&arg7, jarg7)) return 0; 
  result = (int)deconv_device(arg1,arg2,arg3,arg4,arg5,arg6,arg7);
  jresult = (jint)result; 
