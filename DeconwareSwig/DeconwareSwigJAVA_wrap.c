...
SWIGEXPORT jfloat JNICALL Java_com_deconware_wrappers_DeconwareSwigJNI_dot_1device(JNIEnv *jenv, jclass jcls, jlong jarg1, jfloatArray jarg2, jfloatArray jarg3) {
  jfloat jresult = 0 ;
  size_t arg1 ;
  float *arg2 = (float *) 0 ;
  float *arg3 = (float *) 0 ;
  ...
  result = (float)dot_device(arg1,arg2,arg3);
